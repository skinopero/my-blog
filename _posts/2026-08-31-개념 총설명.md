...
![작업대, 상자, 내 창고, 마을 광장 네 장소를 add, commit, push, pull 화살표로 연결한 그림]({{ site.baseurl }}/assets/images/2026-08-31-four-places-flow.svg)
...
![빈 땅에 git init 명령으로 창고가 생기는 그림]({{ site.baseurl }}/assets/images/2026-08-31-init-empty-land.svg)
...
![상자 속 블록이 git commit으로 탑의 새 층으로 고정되는 그림]({{ site.baseurl }}/assets/images/2026-08-31-commit-lock-layer.svg)
...
![내 창고와 마을 광장 사이를 push는 보내고 pull은 받아오는 그림]({{ site.baseurl }}/assets/images/2026-08-31-push-pull-square.svg)
...
![git reset으로 잘못 쌓은 3층 블록이 사라지고 2층으로 돌아가는 그림]({{ site.baseurl }}/assets/images/2026-08-31-reset-remove-layer.svg)
