...
![main 탑은 그대로 두고 test 깃발만 새 블록 위에 꽂는 그림]({{ site.baseurl }}/assets/images/2026-08-31-branch-tower-flags.svg)
...
![같은 블록 더미 위에 main 깃발과 test 깃발이 서로 다른 층을 가리키는 그림]({{ site.baseurl }}/assets/images/2026-08-31-branch-same-blocks-flags.svg)
...
![branch, checkout, checkout -b, branch -d 네 명령어를 깃발 아이콘으로 비교한 그림]({{ site.baseurl }}/assets/images/2026-08-31-branch-commands-cheatsheet.svg)
...
![S-T-A-R 네 단계를 타임라인으로 표현한 그림]({{ site.baseurl }}/assets/images/2026-08-31-branch-star-timeline.svg)
