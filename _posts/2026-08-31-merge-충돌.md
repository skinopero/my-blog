...
![main과 test가 같은 3층 블록을 각각 빨간색과 파란색으로 칠해서 CONFLICT가 나는 그림]({{ site.baseurl }}/assets/images/2026-08-31-merge-conflict-color-block.svg)
...
![터미널에 git merge test 실행 후 CONFLICT 메시지가 뜨는 화면 그림]({{ site.baseurl }}/assets/images/2026-08-31-merge-terminal-mockup.svg)
...
![충돌난 블록에 HEAD, =======, test 표시 테이프가 붙어서 위는 main 색, 아래는 test 색으로 나뉜 그림]({{ site.baseurl }}/assets/images/2026-08-31-merge-conflict-tape.svg)
...
![충돌 중인 블록에서 git merge --abort로 main 탑과 test 탑이 갈라졌던 상태로 되돌아가는 그림]({{ site.baseurl }}/assets/images/2026-08-31-merge-abort-brush.svg)
